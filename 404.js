...
if (menuToggle) {
    ...
    if (contactForm) {
        contactForm.addEventListener('submit', function(e) {
            ...
            const subject = contactForm.querySelector('input[placeholder="Assunto"]').value;
            ...
            // Em uma implementação real, aqui enviaríamos os dados para um servidor
    ...
    // Função para inicializar vídeos (será implementada quando houver vídeos reais)
    function initVideos() {
